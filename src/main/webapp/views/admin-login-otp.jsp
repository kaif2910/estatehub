...
<c:if test="${empty sessionScope.pendingAdminEmail}">
...
<span class="material-symbols-outlined text-primary-container text-[32px]">admin_panel_settings</span>
</div>
...
<span class="font-caption text-caption text-on-surface-variant font-medium">Secured Admin Login</span>
</div>
...
<span class="font-caption text-caption font-semibold">2FA Secured</span>
</div>
</div>
